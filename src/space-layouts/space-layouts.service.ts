      ...
      input: [
        {
          ...
          content: [
            ...
            {
              type: "input_text",
              text: "Entrance opening rule: when a label such as ulaz, glavni ulaz, entrance, or main entrance is placed on or directly next to a wall/boundary line, cut that wall at the entrance position instead of returning one continuous wall across it. Leave an opening about 0.9-1.2 meters wide, roughly the visual width needed for a normal cafe entrance. Do not return a separate door icon marker for that label; represent the entrance primarily as a physical gap in the wall. No wall fixture or outline segment may cross the entrance opening.",
            },
          ],
        },
        {
          ...
          content: [
            ...
            {
              type: "input_text",
              text: "Entrance opening rule: if ulaz/glavni ulaz/entrance/main entrance is marked on a wall, split or shorten the wall so the entrance is physically open. Use an opening around 0.9-1.2 meters wide. Do not place an entrance icon over the wall and do not leave a wall line crossing that opening.",
            },
            ...floorPlanContent,
          ],
        },
